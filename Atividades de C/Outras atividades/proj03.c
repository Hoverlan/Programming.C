/*Elabore um algoritmo utilizando, obrigatoriamente, alocação dinâmica e função, que:
 Realize o cadastro de produtos, contendo: código, nome, preço de compra,
 preço de venda, quantidade. Realize as seguintes ações: incluir, excluir, 
 editar, pesquisar, realizar backup*/
